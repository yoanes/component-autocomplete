...
<log4j:configuration xmlns:log4j="http://jakarta.apache.org/log4j/" debug="false">
    ...
    <appender name="FILE" class="org.apache.log4j.DailyRollingFileAppender">
        <param name="File" value="${catalina.base}/logs/autocomplete-component-showcase.log"/>
    ...
    <appender name="RESOURCE_RESOLUTION_WARN_LOG" class="org.apache.log4j.DailyRollingFileAppender">
        <param name="File" value="${catalina.base}/logs/autocomplete-component-showcase-resource-resolution-warnings.log"/>
        <param name="Append" value="true"/>
        <param name="Threshold" value="DEBUG"/>
        <param name="DatePattern" value="'.'yyyy-MM-dd"/>
