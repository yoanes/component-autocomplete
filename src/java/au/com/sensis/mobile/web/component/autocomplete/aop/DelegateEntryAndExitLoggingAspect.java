package au.com.sensis.mobile.web.component.autocomplete.aop;
...
public class DelegateEntryAndExitLoggingAspect
     ...
     */
    @Pointcut("bean(autocomplete.*Delegate)")
    protected final void autocompleteDelegate() { }
